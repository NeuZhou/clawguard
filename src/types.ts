...
export const DEFAULT_CONFIG: WatchConfig = {
  ...
  security: {
    enabledRules: ['prompt-injection', 'data-leakage', 'anomaly-detection', 'compliance', 'file-protection', 'identity-protection', 'mcp-security', 'supply-chain', 'privilege-escalation', 'rug-pull', 'resource-abuse', 'cross-agent-contamination', 'compliance-frameworks', 'insider-threat', 'memory-attacks'],
